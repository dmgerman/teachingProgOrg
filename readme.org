...
- Then run emacs and try the file readme.org or create your own

Then you can decide how to integrate it to your workflow:

- Run it as is (I recommend you use [[https://github.com/plexus/chemacs][chemacs]] to switch between your own configuration and this one)
  - when teaching run one instance of emacs specifically configured for this purpose
- Cut-and-paste from dmg-org.org to your own configuration files
